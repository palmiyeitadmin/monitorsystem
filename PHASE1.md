ERA Monitor - Development Phases (Backend-First Approach)Project OverviewProject Name: ERA Monitor
Description: A comprehensive server and service monitoring platform with Windows/Linux agents, HTTP/TCP checks, incident management, and customer portal.
Tech Stack:
...
Windows Agent: Go + Fyne (GUI)
Linux Agent: Go (CLI/Service)
Authentication: JWT + Optional Microsoft SSO
Real-time: SignalR for live updates
Notifications: Email (SMTP), Telegram Bot API, Webhooks
Design Assets: All UI designs are available in /stitch_admin_dashboard_home folder with screenshots and HTML exports.PHASE 1: Project Setup & Database Schema (Days 1-3)1.1 Project Structure SetupCreate the following solution structure:ERAMonitor/
├── src/
│   ├── ERAMonitor.API/                    # .NET 8 Web API
│   │   ├── Controllers/
│   │   ├── Middleware/
│   │   ├── Extensions/
│   │   └── Program.cs
...
│   │   └── DTOs/
│   │
│   ├── ERAMonitor.Infrastructure/         # Data Access & External Services
│   │   ├── Data/
│   │   ├── Repositories/
│   │   ├── Services/
│   │   └── Migrations/
│   │
│   ├── ERAMonitor.BackgroundJobs/         # Hangfire Jobs
│   │   ├── Jobs/
│   │   └── Services/
│   │
│   └── ERAMonitor.Agent/                  # Go Agent (separate repo or folder)
│       ├── cmd/
│       ├── internal/
│       └── ui/
│
...
│
└── docs/
    └── api/1.2 Database Schema (PostgreSQL)Create the complete database schema with all tables, relationships, and indexes:sql-- =============================================
...
INSERT INTO locations (organization_id, name, category, provider_name, city, country) VALUES 
    ...
    ('00000000-0000-0000-0000-000000000001', 'Azure West Europe', 'CloudProvider', 'Microsoft Azure', 'Amsterdam', 'Netherlands');1.3 Entity Framework Core SetupCreate the DbContext and configure Entity Framework:csharp// ERAMonitor.Infrastructure/Data/ApplicationDbContext.cs
